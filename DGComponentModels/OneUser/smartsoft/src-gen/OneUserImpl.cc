...
OneUserImpl::OneUserImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

OneUserImpl::OneUserImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

OneUserImpl::~OneUserImpl() 
{  }

int OneUserImpl::startComponentInfrastructure(void)
{
...
void OneUserImpl::stopComponentInfrastructure(const std::chrono::steady_clock::duration &timeoutTime)
{
	this->signalSmartTasksToStop(timeoutTime);
}
void OneUserImpl::cleanUpComponentResources()
{
