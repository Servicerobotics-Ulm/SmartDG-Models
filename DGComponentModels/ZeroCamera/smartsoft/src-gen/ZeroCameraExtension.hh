...
#ifndef ZEROCAMERA_EXTENSION_HH_
#define ZEROCAMERA_EXTENSION_HH_
...
public:
	ZeroCameraExtension(const std::string &name);
	virtual ~ZeroCameraExtension();
...
#endif /* ZEROCAMERA_EXTENSION_HH_ */
