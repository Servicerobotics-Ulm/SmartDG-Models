...
#ifndef TWOMAPMAKER_EXTENSION_HH_
#define TWOMAPMAKER_EXTENSION_HH_
...
public:
	TwoMapMakerExtension(const std::string &name);
	virtual ~TwoMapMakerExtension();
...
#endif /* TWOMAPMAKER_EXTENSION_HH_ */
