...
//--------------------------------------------------------------------------
#ifndef _IMAGEJOINER_CORE_HH
#define _IMAGEJOINER_CORE_HH
...
private:
	...
	std::list<ImageJoinerObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(ImageJoinerObserverInterface *observer);
	void detach_interaction_observer(ImageJoinerObserverInterface *observer);

public:
	ImageJoinerCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~ImageJoinerCore();
