...
TwoMapMakerImpl::TwoMapMakerImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

TwoMapMakerImpl::TwoMapMakerImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

TwoMapMakerImpl::~TwoMapMakerImpl() 
{  }

int TwoMapMakerImpl::startComponentInfrastructure(void)
{
...
void TwoMapMakerImpl::stopComponentInfrastructure(const std::chrono::steady_clock::duration &timeoutTime)
{
	this->signalSmartTasksToStop(timeoutTime);
}
void TwoMapMakerImpl::cleanUpComponentResources()
{
