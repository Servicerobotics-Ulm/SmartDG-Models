...
GrayImageCollector::GrayImageCollector(SmartACE::SmartComponent *comp) 
:	GrayImageCollectorCore(comp)
{
	std::cout << "constructor GrayImageCollector\n";
}
GrayImageCollector::~GrayImageCollector() 
{
	std::cout << "destructor GrayImageCollector\n";
}
...
int GrayImageCollector::on_execute()
{
...
int GrayImageCollector::on_exit()
{
