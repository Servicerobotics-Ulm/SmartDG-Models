#!/bin/bash
#
# Start-Stop-Hooks for component Cam1
#
...
pre-start)
	...
	bash startstop-hooks-component-ZeroCamera.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ZeroCamera.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ZeroCamera.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ZeroCamera.sh post-stop
