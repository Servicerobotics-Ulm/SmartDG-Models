#!/bin/bash
#
# Start-Stop-Hooks for component Dewey
#
...
pre-start)
	...
	bash startstop-hooks-component-OneUser.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-OneUser.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-OneUser.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-OneUser.sh post-stop
