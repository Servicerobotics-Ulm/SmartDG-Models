#!/bin/bash
#
# Start-Stop-Hooks for component Mapper
#
...
pre-start)
	...
	bash startstop-hooks-component-TwoMapMaker.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-TwoMapMaker.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-TwoMapMaker.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-TwoMapMaker.sh post-stop
